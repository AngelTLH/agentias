...
## 2. Metodología
Se utiliza una muestra sintética o estándar (como el dataset de juguete `iris` o `mtcars`) para ilustrar las fases metodológicas:
1. Análisis descriptivo unidimensional y bidimensional.
2. Contraste de hipótesis para medias (prueba t de Student o ANOVA).
3. Verificación de supuestos de normalidad y homocedasticidad.

...
\begin{minipage}{0.2\linewidth}
    ...
    \begin{minipage}{0.21\linewidth}
        \centering
        \includegraphics[width=0.65\linewidth]{img/modelo/profmat-logo.png}
...
\renewcommand\small{\@setfontsize\small{7}{8}}
\renewcommand\footnotesize{\@setfontsize\footnotesize{6.5}{7.5}}
\makeatother
